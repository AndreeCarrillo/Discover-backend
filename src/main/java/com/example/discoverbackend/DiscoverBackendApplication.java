...
public class DiscoverBackendApplication {
    ...
    public CommandLineRunner mappingDemo(
        ...
        return args -> {
            ...
            opinionRepository.save(new Opinion(usuario1, inmueble1, 4, "El inmueble estaba bien ubicado y era cómodo. La comunicación con el anfitrión fue excelente. Sin embargo, el baño podría haber estado más limpio.", "https://i.postimg.cc/52GWnbtW/pousada-casa-do-molino.jpg"));
            opinionRepository.save(new Opinion(usuario3, inmueble4, 5, "Gran experiencia en este inmueble. Las habitaciones eran amplias y la ubicación perfecta. La atención del anfitrión fue inmejorable.", ""));
            opinionRepository.save(new Opinion(usuario20, inmueble6, 3, "El inmueble estaba bien en general, pero la conexión a internet era lenta y la cocina necesitaba más utensilios.", "https://i.postimg.cc/qRTY5RVS/interior-de-la-cocina-vac-a-91263131.jpg"));
            opinionRepository.save(new Opinion(usuario5, inmueble2, 5, "Pasamos un tiempo maravilloso en este inmueble. Las habitaciones eran cómodas y la cocina estaba bien equipada. La ubicación era excelente, cerca de restaurantes y tiendas.", ""));
            opinionRepository.save(new Opinion(usuario11, inmueble8, 4, "El inmueble era amplio y limpio. La ubicación era conveniente, pero el ruido de la calle era un poco molesto durante la noche.", "https://i.postimg.cc/D0CM0PJ3/tipos-de-muebles-para-sala.webp"));
            opinionRepository.save(new Opinion(usuario8, inmueble14, 3, "El inmueble tenía una excelente ubicación, pero faltaba mantenimiento en algunas áreas. La atención del anfitrión fue buena.", ""));
            opinionRepository.save(new Opinion(usuario10, inmueble14, 4, "El inmueble era agradable y cómodo, pero podría haber estado un poco más limpio. La atención del anfitrión fue muy amable y atenta.", ""));
            opinionRepository.save(new Opinion(usuario19, inmueble12, 4, "El inmueble estaba bien ubicado y tenía un diseño agradable. El anfitrión fue atento, pero había poco espacio para guardar nuestras pertenencias.", "https://i.postimg.cc/QMpY139b/maneras-volver-sala-estar-acogedora.webp"));
            opinionRepository.save(new Opinion(usuario17, inmueble14, 5, "Disfrutamos mucho de nuestra estancia en este inmueble. Era espacioso, cómodo y bien decorado. El anfitrión fue muy amable y siempre estuvo disponible para responder nuestras preguntas.", ""));
            opinionRepository.save(new Opinion(usuario1, inmueble16, 3, "El inmueble era básico pero funcional. La ubicación era buena, pero el ruido de los vecinos era un poco molesto. El anfitrión fue atento y servicial.", "https://i.postimg.cc/4Nm8wtHn/mejor-puerta-para-casa-1.jpg"));
            opinionRepository.save(new Opinion(usuario17, inmueble15, 4, "El inmueble estaba limpio y bien cuidado, pero la conexión Wi-Fi era lenta y poco confiable. El anfitrión fue amable y atento a nuestras necesidades.", ""));
            opinionRepository.save(new Opinion(usuario6, inmueble17, 5, "El inmueble era hermoso y bien mantenido. La ubicación era excelente, y el anfitrión fue muy atento y siempre estuvo disponible para ayudarnos.", "https://i.postimg.cc/MG8dWFPj/thread-21950169-15070763766771596119.png"));
            opinionRepository.save(new Opinion(usuario12, inmueble13, 5, "Nos encantó nuestra estancia en este inmueble. Estaba impecablemente limpio y bien equipado. La ubicación era perfecta, y el anfitrión fue muy servicial y atento.", ""));
            opinionRepository.save(new Opinion(usuario6, inmueble12, 4, "El inmueble estaba en una ubicación conveniente y tenía todo lo necesario para nuestra estancia. Sin embargo, el ruido de la calle era un poco molesto por la noche.", ""));
            opinionRepository.save(new Opinion(usuario6, inmueble18, 3, "El inmueble era cómodo pero un poco antiguo. La ubicación era buena, pero el estacionamiento era un problema. El anfitrión fue amable y atento.", "https://i.postimg.cc/Kz0NDvZn/estacionamiento-856838.jpg"));
            opinionRepository.save(new Opinion(usuario19, inmueble9, 4, "El inmueble era agradable y tenía una buena ubicación. El anfitrión fue atento y servicial. Sin embargo, la conexión Wi-Fi era irregular y el estacionamiento era limitado.", ""));
            opinionRepository.save(new Opinion(usuario7, inmueble12, 5, "Disfrutamos mucho de nuestra estancia en este inmueble. La ubicación era excelente y el anfitrión fue muy amable y servicial. El inmueble estaba muy limpio y bien equipado.", ""));
            opinionRepository.save(new Opinion(usuario5, inmueble20, 4, "El inmueble estaba en buenas condiciones y la ubicación era conveniente. Sin embargo, el ruido del tráfico fue un problema durante nuestra estancia. El anfitrión fue amable y atento.", ""));
            opinionRepository.save(new Opinion(usuario11, inmueble11, 5, "Tuvimos una estancia estupenda en este inmueble. La ubicación era perfecta, cerca de tiendas y restaurantes. El anfitrión fue muy servicial y nos proporcionó todo lo que necesitábamos.", "https://i.postimg.cc/abcdef/sample-photo-19.jpg"));
            opinionRepository.save(new Opinion(usuario5, inmueble8, 4, "El inmueble era cómodo y bien ubicado. La cocina estaba bien equipada, pero el baño necesitaba una actualización. El anfitrión fue muy amable y servicial.", ""));
            opinionRepository.save(new Opinion(usuario5, inmueble13, 5, "El inmueble tenía una vista increíble y estaba ubicado en un vecindario tranquilo. ¡Definitivamente lo recomendaría!", "https://i.postimg.cc/g23HBKzc/departamento-1.webp"));
            opinionRepository.save(new Opinion(usuario17, inmueble3, 3, "El inmueble estaba bastante limpio, pero algunos electrodomésticos no funcionaban correctamente y la conexión Wi-Fi era inestable.", ""));
            opinionRepository.save(new Opinion(usuario9, inmueble6, 4, "Disfrutamos nuestra estancia en este inmueble, aunque el estacionamiento era un poco limitado. La ubicación era excelente.", "https://ejemplo.com/foto_resena_23.jpg"));
            opinionRepository.save(new Opinion(usuario16, inmueble20, 5, "El diseño del inmueble era moderno y la atención al detalle era excepcional. Nos encantó nuestra estancia.", ""));
            opinionRepository.save(new Opinion(usuario9, inmueble15, 4, "El inmueble estaba en una ubicación conveniente, pero el ruido de la calle era un poco molesto por la noche. En general, una buena experiencia.", "https://i.postimg.cc/B67T1Ygp/348446570.webp"));
            opinionRepository.save(new Opinion(usuario3, inmueble14, 4, "El departamento es espacioso y bien ubicado. La atención del anfitrión fue excelente. Sin embargo, el ruido de la calle era un poco molesto por las noches.", ""));
            opinionRepository.save(new Opinion(usuario19, inmueble5, 5, "Nos encantó nuestra estadía en este inmueble. La vista era increíble y estaba cerca de restaurantes y tiendas. El anfitrión fue muy amable y atento.", ""));
            opinionRepository.save(new Opinion(usuario6, inmueble11, 3, "El lugar estaba bien, pero la limpieza dejaba mucho que desear. Además, hubo problemas con el Wi-Fi durante nuestra estancia.", ""));
            opinionRepository.save(new Opinion(usuario15, inmueble20, 4, "El inmueble era cómodo y tenía todo lo necesario para nuestra estancia. La ubicación era conveniente. Sin embargo, sería bueno agregar más utensilios de cocina.", "https://i.postimg.cc/JzQPzQ96/como-pintar-departamento-forma-correcta.jpg"));
            opinionRepository.save(new Opinion(usuario9, inmueble3, 4, "El apartamento estaba bien ubicado y tenía una decoración agradable. La comunicación con el anfitrión fue buena. Aunque el baño podría haber estado más limpio.", ""));
            opinionRepository.save(new Opinion(usuario4, inmueble17, 5, "La casa era encantadora y muy espaciosa. La zona era tranquila y perfecta para nuestro grupo. El anfitrión fue muy atento y nos proporcionó información útil sobre la zona.", ""));
            opinionRepository.save(new Opinion(usuario13, inmueble8, 3, "El inmueble estaba bien ubicado, pero la limpieza no era la mejor. Encontramos algunas áreas sucias y había un olor desagradable en el baño.", ""));
            opinionRepository.save(new Opinion(usuario11, inmueble12, 4, "El departamento tenía una vista maravillosa y estaba cerca de restaurantes y tiendas. Sin embargo, el estacionamiento era un poco complicado.", ""));
            opinionRepository.save(new Opinion(usuario20, inmueble4, 5, "La decoración del inmueble era increíble y la cocina estaba bien equipada. La ubicación era céntrica, lo que facilitó el acceso a lugares de interés turístico y restaurantes.", "https://i.postimg.cc/667jfnvq/venta-de-departamento-cajamarca-groenlandia-3-dormitorios-4-ba-os-2030093660989036323.jpg"));
            opinionRepository.save(new Opinion(usuario7, inmueble9, 4, "El departamento era acogedor y tenía una excelente vista. La comunicación con el anfitrión fue fluida. Sin embargo, el colchón de la cama podría haber sido más cómodo.", ""));
            opinionRepository.save(new Opinion(usuario18, inmueble1, 3, "La ubicación era buena, pero el lugar necesitaba mejoras en la limpieza y mantenimiento. Además, el Wi-Fi no funcionaba correctamente.", ""));
            opinionRepository.save(new Opinion(usuario5, inmueble15, 5, "Disfrutamos mucho de nuestra estancia en esta casa. Estaba bien amueblada y tenía un hermoso jardín. El anfitrión fue muy atento y nos proporcionó recomendaciones locales.", "https://i.postimg.cc/mrXjQgZ7/ey-Jid-WNr-ZXQi-Oi-Jwcm-Qtb-Glmd-Wxs-Y29ubm-Vjd-C1i-YWNr-ZW5k-LWIy-Yi1pb-WFn-ZXMi-LCJr-ZXki-Oi-Jwcm9w-ZXJ0a-WVz-L2-U5-OTM2-Mz-Jk.jpg"));
            opinionRepository.save(new Opinion(usuario14, inmueble6, 4, "El inmueble tenía una terraza agradable y estaba cerca de tiendas y restaurantes. La comunicación con el anfitrión fue buena. No obstante, el ruido del vecindario por las noches era un poco molesto.", ""));
            opinionRepository.save(new Opinion(usuario2, inmueble19, 4, "El lugar era bastante amplio y tenía mucha luz natural. La ubicación era conveniente. Sin embargo, la conexión a internet podría haber sido mejor.", ""));
            opinionRepository.save(new Opinion(usuario16, inmueble10, 3, "El apartamento estaba bien, pero le faltaba mantenimiento en algunas áreas. Además, el equipamiento de la cocina era escaso.", "https://i.postimg.cc/B6zFv8Sw/que-es-un-departamento-duplex.jpg"));
            opinionRepository.save(new Opinion(usuario1, inmueble18, 5, "La casa estaba impecablemente limpia y tenía todas las comodidades necesarias. El anfitrión fue muy atento y nos ayudó con todas nuestras dudas.", ""));
            opinionRepository.save(new Opinion(usuario17, inmueble2, 4, "El apartamento tenía una buena ubicación, cerca de parques y supermercados. La comunicación con el anfitrión fue fluida. No obstante, la presión del agua en la ducha era baja.", "https://i.postimg.cc/6pVCh5cy/venta-de-un-departamento-DEV358951660704964-13.jpg"));
            opinionRepository.save(new Opinion(usuario8, inmueble16, 4, "El inmueble contaba con un diseño agradable y estaba bien ubicado. El anfitrión fue amable. Sin embargo, faltaba un poco de limpieza en el baño.", ""));
            opinionRepository.save(new Opinion(usuario10, inmueble13, 5, "El departamento era espacioso y tenía una excelente vista. La ubicación era perfecta para explorar la ciudad. El anfitrión fue atento y siempre estuvo disponible para ayudarnos.", ""));
            opinionRepository.save(new Opinion(usuario19, inmueble4, 3, "Hola, no me gusta", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble18, 3, "Hola no me gusto", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble6, 3, "Hola, sigue sin gustarme", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble7, 4, "Me gusto mucho el inmueble", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble7, 3, "No me gusto mucho el inmueble", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble9, 5, "Me gusto mucho el inmueble", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble19, 3, "El lugar era bastante amplio y tenía mucha luz natural. La ubicación era conveniente. Sin embargo, la conexión a internet podría haber sido mejor.", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble1, 2, "No me gusta", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble8, 3, "Me gusta", "https://i.postimg.cc/k5mRVLnk/84459.png"));
            opinionRepository.save(new Opinion(usuario19, inmueble5, 4, "Excelente experiencia", "https://i.postimg.cc/k5mRVLnk/84459.png"));
